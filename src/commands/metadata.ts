...
export const commandMetadata: CommandMetadata[] = [
  ...
  },
  {
    ...
    args: [{ name: 'track', required: true, description: 'Track ID or title to update' }],
    usage:
      'track update <track> [--title "..."] [--summary "..."] [--next "..."] [--status <status>] [--file <file-path>]... [--worktree <name>] [--blocks <track-id>]... [--unblocks <track-id>]...',
    example: 'track update "Add login screen" --summary "API wired" --status done',
  },
  {
    name: 'status',
    ...
    args: [
      {
        name: 'track',
        required: false,
        description: 'Optional track ID or title to show status for (with descendants)',
      },
    ],
    usage:
      'track status [track] [--json] [-m|--markdown] [-a|--all] [-w|--worktree [name]] [--archived]',
    example: 'track status "Add login screen" --json',
  },
  {
    name: 'show',
    ...
    args: [{ name: 'track', required: true, description: 'Track ID or title to display' }],
    usage: 'track show <track> [--json]',
    example: 'track show "Add login screen" --json',
  },
  {
    name: 'mcp',
  ...
  },
  {
    ...
    args: [{ name: 'track', required: true, description: 'Track ID or title to delete' }],
    usage: 'track delete <track> [-f|--force]',
    example: 'track delete "Add login screen" --force',
  },
  {
    name: 'sort',
    ...
    flags: [],
    args: [
      { name: 'track', required: true, description: 'Track ID or title to move' },
      { name: 'position', required: true, description: 'Position: before or after' },
      { name: 'target', required: true, description: 'Target track ID or title' },
    ],
    usage: 'track sort <track> <before|after> <target>',
    example: 'track sort "Add login screen" before "Add dashboard"',
  },
  {
    name: 'archive',
    summary: 'Archive a completed track (done, on_hold, or superseded)',
    flags: [],
    args: [{ name: 'track', required: true, description: 'Track ID or title to archive' }],
    usage: 'track archive <track>',
    example: 'track archive "Add login screen"',
  },
  {
    name: 'unarchive',
    summary: 'Restore an archived track to normal visibility',
    flags: [],
    args: [{ name: 'track', required: true, description: 'Track ID or title to unarchive' }],
    usage: 'track unarchive <track>',
    example: 'track unarchive "Add login screen"',
  },
];
